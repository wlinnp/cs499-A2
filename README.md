...
## Explanation for Entities and Relationships
There are 3 entities Student, Lecturer, and Classes.
 
Relationships are 
1. Many classes can be taught by many lecturers. (Many to Many)
- 1 teacher can teach many classes. 
- 1 class can have different sections by different lecturers. (Many to Many)
2. Many classes can have any students. 
- 1 class can have many students. 
- 1 student can take multiple classes. (One to Many)
3. 1 lecturer can teach many students. 
...
To optimize the cs499p2 application for production, run:
